...
function addToTable(tableId, name, calories){
  ...
  var diaryData = `<tr><td>${name}</td><td>${calories}</td></tr>`;

  if(tableId.includes("diary")){
    $(`#${tableId} > tbody > tr:first`).before(diaryData);
  } else {
...
$(document).ready(function(){
  ...
  displayItems("food-calories", "diary-exercise-table");
})
